...
def train_and_evaluate_models(modeling_datasets):
    ...
    for rq_name, dataset_info in modeling_datasets.items():
        ...
        # For simple linear regression, use best single feature
        if rq_name == 'RQ1':
            correlations = []
...
def perform_bootstrapping(modeling_datasets, all_results, n_bootstrap=100):
...
def train_all_models(modeling_datasets):
    ...
    bootstrap_results = perform_bootstrapping(modeling_datasets, all_results, n_bootstrap=100)
